...
class Listing extends React.Component {
  ...
  SaveToFavorites = (e) =>{
      ...
      axios.post(ROOT_URL + '/favorite', favReq )
        .then(function (res) {
            console.log(res);
          })
          .catch(function(error) {
  ...
  handleSubmitLease = (e) => {
      ...
      console.log(sendRentLease);
      //
      // axios.post(ROOT_URL + '/buyer/send-email', sendRentLease )
      // .then(function (res) {
      //     console.log(res);
      //   })
      //   .catch(function(error) {
              ...
              <Jumbotron>
                ...
                <Container>
                  ...
                  <Row>
                    ...
                    <Col><Button onClick={() => this.SaveToFavorites(card._id)} color="warning">Save to Favorites</Button></Col>

                    { sessionStorage.getItem("role") == "Buyer" || sessionStorage.getItem("role") == "Realtor" ?
                    <Col>
                        <Button color="success"  onClick={() => this.handleShowBuyer(card._id)}>Send a Buyer Offer</Button>
                    </Col>
                    :
                    ...
                    { sessionStorage.getItem("role") == "Renter" && card.listingType == "Rent" ?
                      <Col>
                        ...
                        <Button color="secondary"  onClick={() => this.handleShow(card._id)}>Send Lease Application</Button>
                    ...
                    <Col>
                    <div>
                        <Button color="info"  onClick={() => this.handleShow(card._id)}>Schedule Open House</Button>
                        <Modal show={this.state.show} onHide={this.handleClose}>
                          <Modal.Header closeButton>
                            <Modal.Title>Schedule Open House</Modal.Title>
                          </Modal.Header>
...
class Home extends React.Component {
  ...
  onFav = e => {
      ...
      axios.post(ROOT_URL + '/favoriteSearch', params).then((res) => {
          console.log("inside fav search save");
          console.log(res);
          })
          .catch(function(error) {
              console.log(error)
  ...
  render()
  {
    ...
    return(
      <div>
       ...
       {/*
       <Button color="warning" onClick={this.handleClick}>View Favorites</Button>*/}
